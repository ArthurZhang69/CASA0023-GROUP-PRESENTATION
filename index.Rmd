...
<span style="display:inline-block; background:var(--bg-card); border:1px solid rgba(201,169,110,0.5); color:var(--gold); font-family:var(--font-body); font-size:0.7em; font-weight:500; letter-spacing:0.15em; text-transform:uppercase; padding:0.35em 0.9em; border-radius:2px; margin-bottom:0rem;">CASA0023 · Remotely Sensing Cities and Environments · 2026</span>
...
<div style="overflow:hidden; height:108vh; margin-top:-6rem;">
...
<img src="Content From ShiYao Zhang/Flowchart2-refined.png" style="width:100%; max-height:48vh; object-fit:contain; display:block;margin-top:-1.6rem;margin-left:-2rem">
...
.slide-label[Slide 136 · Project Plan · zhexiang zhou]
